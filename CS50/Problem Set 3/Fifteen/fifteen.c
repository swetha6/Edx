...
void swap_1(int row1, int col1, int row2, int col2);
...
bool move(int tile)
{
    ...
    {
        swap_1(tile_position[0], tile_position[1], blank_position[0], blank_position[1]);
        return true;
    }
    return false;
}
...
/**
 * swap_1s the values of two tiles
 */
void swap_1(int row1, int col1, int row2, int col2)
{
